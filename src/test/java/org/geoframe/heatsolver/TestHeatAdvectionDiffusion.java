 ...
 */
public class TestHeatAdvectionDiffusion extends WGTestCase {
	...
	public void testHeatAdvectionDiffusion() throws Exception {
		...
		String pathInternalEnergyTopBC = getRes("/input/TimeSeries/airT_T0135.csv");
		String pathInternalEnergyBottomBC = getRes("/input/TimeSeries/bottomT_T0135.csv");
		String pathRichardsTopBC = getRes("/input/TimeSeries/Precip_T0135.csv");
		String pathRichardsBottomBC = getRes("/input/TimeSeries/Precip_T0135.csv");
		...
		OmsTimeSeriesIteratorReader topInternalEnergyBCReader = getTimeseriesReader(pathInternalEnergyTopBC, fId,
				startDate, endDate, timeStepMinutes);
		OmsTimeSeriesIteratorReader bottomInternalEnergyBCReader = getTimeseriesReader(pathInternalEnergyBottomBC, fId,
				startDate, endDate, timeStepMinutes);
		OmsTimeSeriesIteratorReader topRichardsBCReader = getTimeseriesReader(pathRichardsTopBC, fId, startDate,
				endDate, timeStepMinutes);
		OmsTimeSeriesIteratorReader bottomRichardsBCReader = getTimeseriesReader(pathRichardsBottomBC, fId, startDate,
				endDate, timeStepMinutes);
		OmsTimeSeriesIteratorReader saveDatesReader = getTimeseriesReader(pathSaveDates, fId, startDate, endDate,
				timeStepMinutes);
