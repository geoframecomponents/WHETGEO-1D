...
public class Richards1DFiniteVolumeSolver {
	...
	public Richards1DFiniteVolumeSolver( IBoundaryCondition topBoundaryCondition, IBoundaryCondition bottomBoundaryCondition, int KMAX, int nestedNewton, double newtonTolerance, double delta,
