...
import it.geoframe.blogspot.whetgeo1d.data.ComputeQuantitiesHeatDiffusionWithSurfaceEnergyBalance;
...
import it.geoframe.blogspot.whetgeo1d.pdefinitevolume.HeatDiffusionWithSurfaceEnergyBalance1DFiniteVolumeSolver;
	...
	public void solve() {
		...
		if(step==0){
			...
			computeQuantities = new ComputeQuantitiesHeatDiffusionWithSurfaceEnergyBalance(typeClosureEquation, typeEquationState, typeThermalConductivity, interfaceThermalConductivityModel, bottomBCType,
					surfaceAlbedoType, surfaceEmissivityType, surfaceAereodynamicResistanceType, surfaceWaterVaporResistanceType);
