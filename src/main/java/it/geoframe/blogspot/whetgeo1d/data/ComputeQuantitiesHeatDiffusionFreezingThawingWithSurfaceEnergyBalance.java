...
import org.geoframe.whetgeo1d.surfaceproperties.factories.SurfaceWaterVaporResistanceFactory;
...
public class ComputeQuantitiesHeatDiffusionFreezingThawingWithSurfaceEnergyBalance {
	...
	public ComputeQuantitiesHeatDiffusionFreezingThawingWithSurfaceEnergyBalance(String[] typeClosureEquation, String[] typeEquationState, String[] typeThermalConductivity,
	...
	public void computeConductionHeatFlux(int KMAX) {
		...
		// top interface
		variables.conductionHeatFluxs[KMAX] = (1-variables.surfaceAlbedo)*variables.shortWaveIn + variables.surfaceEmissivity*variables.longWaveIn - variables.linearizedLongWaveOut*variables.temperatures[KMAX-1] + variables.sensibleHeatFlux + variables.actualLatentHeatFlux;
