...
public class SurfaceWaterInternalEnergy extends EquationState {
	...
	public SurfaceWaterInternalEnergy(ClosureEquation closureEquation) {
	...
	public double equationState(double x, double y, int id, int element) {
		...
		return super.closureEquation.parameters.waterDensity*super.closureEquation.parameters.specificThermalCapacityWater*f * (y-super.closureEquation.parameters.referenceTemperatureInternalEnergy)
	...
	public double dEquationState(double x, double y, int id, int element) {
		...
		return super.closureEquation.parameters.waterDensity*super.closureEquation.parameters.specificThermalCapacityWater*f;
