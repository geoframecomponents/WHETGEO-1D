package org.geoframe.whetgeo1d.io;
...
public class Whetgeo1DOutputsHandler implements AutoCloseable {
	...
	// table/column names are the shared naming convention hortonmachine-git's DB
	// Viewer chart addon also depends on (see Whetgeo1DOutputSchema's javadoc) -
	// kept there rather than redeclared here so the two sides can't drift apart.
	public static final String PREFIX = Whetgeo1DOutputSchema.PREFIX;

	public static final String TABLE_OUTPUT_GRID = Whetgeo1DOutputSchema.TABLE_OUTPUT_GRID;
	public static final String TABLE_OUTPUT_STATE = Whetgeo1DOutputSchema.TABLE_OUTPUT_STATE;
	public static final String TABLE_OUTPUT_FLUX = Whetgeo1DOutputSchema.TABLE_OUTPUT_FLUX;
	public static final String TABLE_OUTPUT_SCALARS = Whetgeo1DOutputSchema.TABLE_OUTPUT_SCALARS;
	public static final String TABLE_OUTPUT_SWRC_PARAMETERS = Whetgeo1DOutputSchema.TABLE_OUTPUT_SWRC_PARAMETERS;
	public static final String TABLE_OUTPUT_METADATA = Whetgeo1DOutputSchema.TABLE_OUTPUT_METADATA;

	public static final String COL_ID = Whetgeo1DOutputSchema.COL_ID;
	...
	public static final String COL_ETA_DUAL = Whetgeo1DOutputSchema.COL_ETA_DUAL;
	public static final String COL_CONTROL_VOLUME = Whetgeo1DOutputSchema.COL_CONTROL_VOLUME;
	public static final String COL_PSI = Whetgeo1DOutputSchema.COL_PSI;
	public static final String COL_TEMPERATURE_IC = Whetgeo1DOutputSchema.COL_TEMPERATURE_IC;
	public static final String COL_PARAMETER_ID = Whetgeo1DOutputSchema.COL_PARAMETER_ID;
	public static final String COL_THETA_S = Whetgeo1DOutputSchema.COL_THETA_S;
	public static final String COL_THETA_R = Whetgeo1DOutputSchema.COL_THETA_R;
	public static final String COL_KS = Whetgeo1DOutputSchema.COL_KS;
	public static final String COL_N = Whetgeo1DOutputSchema.COL_N;
	public static final String COL_ALPHA = Whetgeo1DOutputSchema.COL_ALPHA;
	public static final String COL_TOP_BC_TYPE = Whetgeo1DOutputSchema.COL_TOP_BC_TYPE;
	public static final String COL_BOTTOM_BC_TYPE = Whetgeo1DOutputSchema.COL_BOTTOM_BC_TYPE;
	public static final String COL_TEMPERATURE = Whetgeo1DOutputSchema.COL_TEMPERATURE;
	public static final String COL_THETA = Whetgeo1DOutputSchema.COL_THETA;
	public static final String COL_INTERNAL_ENERGY = Whetgeo1DOutputSchema.COL_INTERNAL_ENERGY;
	public static final String COL_ICE_CONTENT = Whetgeo1DOutputSchema.COL_ICE_CONTENT;
	public static final String COL_WATER_SUCTION = Whetgeo1DOutputSchema.COL_WATER_SUCTION;
	public static final String COL_HEAT_FLUX = Whetgeo1DOutputSchema.COL_HEAT_FLUX;
	public static final String COL_DARCY_VELOCITY = Whetgeo1DOutputSchema.COL_DARCY_VELOCITY;
	public static final String COL_ERROR = Whetgeo1DOutputSchema.COL_ERROR;
	public static final String COL_TOP_BC = Whetgeo1DOutputSchema.COL_TOP_BC;
	public static final String COL_BOTTOM_BC = Whetgeo1DOutputSchema.COL_BOTTOM_BC;
	public static final String COL_ERROR_VOLUME = Whetgeo1DOutputSchema.COL_ERROR_VOLUME;
	public static final String COL_AIR_T = Whetgeo1DOutputSchema.COL_AIR_T;
	public static final String COL_SHORT_WAVE_IN = Whetgeo1DOutputSchema.COL_SHORT_WAVE_IN;
	public static final String COL_SHORT_WAVE_OUT = Whetgeo1DOutputSchema.COL_SHORT_WAVE_OUT;
	public static final String COL_LONG_WAVE_IN = Whetgeo1DOutputSchema.COL_LONG_WAVE_IN;
	public static final String COL_LONG_WAVE_OUT = Whetgeo1DOutputSchema.COL_LONG_WAVE_OUT;
	public static final String COL_SENSIBLE_HEAT_FLUX = Whetgeo1DOutputSchema.COL_SENSIBLE_HEAT_FLUX;
	public static final String COL_LATENT_HEAT_FLUX = Whetgeo1DOutputSchema.COL_LATENT_HEAT_FLUX;
	public static final String COL_HEAT_FLUX_BOTTOM = Whetgeo1DOutputSchema.COL_HEAT_FLUX_BOTTOM;
