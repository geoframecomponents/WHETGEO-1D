...
import org.geoframe.whetgeo1d.data.ComputeQuantitiesHeatDiffusionFreezingThawingWithSurfaceEnergyBalance;
...
public class HeatDiffusionFreezingThawingSolverWithSurfaceEnergyBalance1DMain {
	...
	public void solve() {
		...
		if(step==0){
			...
			computeQuantities = new ComputeQuantitiesHeatDiffusionFreezingThawingWithSurfaceEnergyBalance(typeClosureEquation, typeEquationState, typeThermalConductivity, interfaceThermalConductivityModel, bottomBCType,
