...
public class HeatAdvectionDiffusionSolverWithSurfaceEnergyBalance1DMain {
	...
	private AdvectionDiffusionWithSurfaceEnergyBalance1DFiniteVolumeSolver advectionDiffusionSolver; // creare un nuovo
																										// solver con il
																										// surface
																										// energy
																										// balance
...
//			stressedETs = new double[KMAX];
			...
			advectionDiffusionSolver = new AdvectionDiffusionWithSurfaceEnergyBalance1DFiniteVolumeSolver(
