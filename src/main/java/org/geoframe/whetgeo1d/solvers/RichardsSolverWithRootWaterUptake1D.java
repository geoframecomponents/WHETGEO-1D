...
@Description("Solve the Richards equation for the 1D domain, with a stressed evapotranspiration sink term for plant root water uptake.")
@Documentation("")
@Author(name = "Concetta D'Amato, Niccolo' Tubini, and Riccardo Rigon", contact = "")
@Keywords("Hydrology, Richards, Infiltration, Root water uptake, Evapotranspiration")
@Bibliography("Casulli (2010)")
//@Label()
//@Name()
//@Status()
@License("General Public License Version 3 (GPLv3)")
public class RichardsSolverWithRootWaterUptake1D extends HMModel {
	...
	public void solve() {
		...
		if (step == 0) {
			...
			richardsSolver = new Richards1DKernel(topBoundaryCondition, bottomBoundaryCondition, KMAX,
