...
import org.geoframe.whetgeo1d.core.derivedquantities.ComputeQuantitiesHeatDiffusionFreezingThawing;
...
public class HeatDiffusionSolverWithFreezingThawing1D extends HMModel {
	...
	private Diffusion1DKernel heatDiffusionSolver;
	...
	public void solve() {
		...
		if(step==0){
			...
			computeQuantities = new ComputeQuantitiesHeatDiffusionFreezingThawing(typeClosureEquation, typeEquationState, typeThermalConductivity, interfaceThermalConductivityModel, 
			...
			heatDiffusionSolver = new Diffusion1DKernel(topBoundaryCondition, bottomBoundaryCondition, KMAX, nestedNewton, newtonTolerance, delta, MAXITER_NEWT, equationState);
