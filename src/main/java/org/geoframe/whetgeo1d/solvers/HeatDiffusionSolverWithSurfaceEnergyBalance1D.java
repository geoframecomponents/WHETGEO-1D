...
import org.geoframe.whetgeo1d.core.derivedquantities.ComputeQuantitiesHeatDiffusionWithSurfaceEnergyBalance;
...
public class HeatDiffusionSolverWithSurfaceEnergyBalance1D extends HMModel {
	...
	public void solve() {
		...
		if (step == 0) {
			...
			heatDiffusionSolver = new HeatDiffusionWithSurfaceEnergyBalance1DKernel(bottomBoundaryCondition,
