//package it.geoframe.blogspot.whetgeo1d.solvers;
//
//	
//}
...
public class HeatDiffusionSolverWithFreezingThawingWithSurfaceEnergyBalance1D extends HMModel {
	...
	public void solve() {
		...
		if(step==0){
			...
			heatDiffusionSolver = new HeatDiffusionWithSurfaceEnergyBalance1DKernel(bottomBoundaryCondition, KMAX, nestedNewton, newtonTolerance, delta, MAXITER_NEWT, equationState);
