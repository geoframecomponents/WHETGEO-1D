...
public class RichardsConservativeSoluteADESolver1D extends HMModel {
	/*
	...
	private IBoundaryCondition topSoluteBoundaryCondition;
	private IBoundaryCondition bottomSoluteBoundaryCondition;
	...
	public void solve() {
		...
		if (step == 0) {
			...
			advectionDispersionSolver = new AdvectionDiffusion1DKernel(topSoluteBoundaryCondition,
		 ...
		 * inInternalEnergyTopBC.get(stationID)[0]/tTimeStep; } else {
		 * variables.internalEnergyTopBCValue =
		 ...
		 * inInternalEnergyBottomBC.get(stationID)[0]/tTimeStep; } else {
		 * variables.internalEnergyBottomBCValue =
		 * inInternalEnergyBottomBC.get(stationID)[0]+273.15; }
		 */
		...
		while (sumTimeDelta < tTimeStep) {
			...
			/*
			 * for(int k=0; k<KMAX; k++) { variables.temperatures[k] =
			 * variables.temperatures[k]-273.15; } variables.internalEnergyTopBCValue =
			 * variables.internalEnergyTopBCValue-273.15;
			 * variables.internalEnergyBottomBCValue =
			 * variables.internalEnergyBottomBCValue-273.15;
			 */
