...
public class ComputeQuantitiesHeatDiffusionWithSurfaceEnergyBalance {
	...
	public ComputeQuantitiesHeatDiffusionWithSurfaceEnergyBalance(String[] typeClosureEquation, String[] typeEquationState, String[] typeThermalConductivity,
		...
		surfaceAereodynamicResistanceModel = ISurfaceAereodynamicResistance.create(SurfaceAereodynamicResistanceType.fromString(surfaceAereodynamicResistanceType));
		surfaceWaterVaporResistanceModel = ISurfaceWaterVaporResistance.create(SurfaceWaterVaporResistanceModel.fromString(surfaceWaterVaporResistanceType));
