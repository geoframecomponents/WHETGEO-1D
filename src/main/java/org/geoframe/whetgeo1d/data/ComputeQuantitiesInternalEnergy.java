...
//		equationState.add(new SoilInternalEnergy(soilWaterRetentionCurve.get(0)));
...
//		thermalConductivity = conductivityEquationFactory.create(typeThermalConductivityModel, soilWaterRetentionCurve.get(0));
	...
	public void computeErrorDiffusion(int KMAX, double timeDelta) {
		...
		/*
		 * FIXME: do not compute again heat fluxes
		 */
...
//			variables.heatFluxBottom = variables.lambdasInterface[0]*(variables.temperatures[0]-variables.internalEnergyBottomBCValue)/geometry.spaceDeltaZ[0];
//		} else if (bottomBCType.equalsIgnoreCase("Bottom Neumann") || bottomBCType.equalsIgnoreCase("BottomNeumann")) {
//			variables.heatFluxBottom = -variables.internalEnergyBottomBCValue;
//		}
//
//		/*
//		 * Compute top heat flux
//		 */
//		if(topBCType.equalsIgnoreCase("Top Dirichlet") || topBCType.equalsIgnoreCase("TopDirichlet")){
//			variables.heatFluxTop = variables.lambdasInterface[KMAX]*(variables.internalEnergyTopBCValue-variables.temperatures[KMAX-1])/geometry.spaceDeltaZ[KMAX];
//		} else if (topBCType.equalsIgnoreCase("Top Neumann") || topBCType.equalsIgnoreCase("TopNeumann")) {
//			variables.heatFluxTop = variables.internalEnergyTopBCValue;
//		} 

		/*
		 * FIXME: missing source-sink term, and eventually volume lost for runoffs
		 */
