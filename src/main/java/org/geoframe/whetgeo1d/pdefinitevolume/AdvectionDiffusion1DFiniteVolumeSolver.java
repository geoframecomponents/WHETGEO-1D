...
public class AdvectionDiffusion1DFiniteVolumeSolver {
	...
	public AdvectionDiffusion1DFiniteVolumeSolver( IBoundaryCondition topBoundaryCondition, IBoundaryCondition bottomBoundaryCondition, int KMAX) {
