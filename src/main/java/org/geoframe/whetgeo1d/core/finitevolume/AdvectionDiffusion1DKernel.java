...
public class AdvectionDiffusion1DKernel {
	...
	public AdvectionDiffusion1DKernel( IBoundaryCondition topBoundaryCondition, IBoundaryCondition bottomBoundaryCondition, int KMAX) {
