...
public class Diffusion1DKernel {
	...
	public Diffusion1DKernel(IBoundaryCondition topBoundaryCondition,
	...
	public double[] solve(double timeDelta, double bottomBCValue, double topBCValue, int KMAX, double[] kappasInterface,
			double[] conservedQuantities, double[] spaceDeltaZ, double[] sourceSinkTerm, double[] x, double[] y,
		...
		upperDiagonal[KMAX - 1] = topBoundaryCondition.upperDiagonal(-999.0, kP, kM, spaceDeltaZ[KMAX],
				spaceDeltaZ[KMAX - 1], timeDelta);
		rhss[KMAX - 1] = conservedQuantities[KMAX - 1] + topBoundaryCondition.rightHandSide(topBCValue, kP, kM,
				spaceDeltaZ[KMAX], spaceDeltaZ[KMAX - 1], timeDelta) - sourceSinkTerm[KMAX - 1];
