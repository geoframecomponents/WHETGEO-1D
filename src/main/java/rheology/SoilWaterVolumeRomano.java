 ...
 *
 */
public class SoilWaterVolumeRomano extends StateEquation {

	private Geometry geometry;
	private ProblemQuantities variables;
	private Bisection bisection;

	public SoilWaterVolumeRomano(Rheology rheology) {
		super(rheology);
	...
	public double p(double x, double y, int id, int element) {
		...
		if(x<=variables.xStar1[element]) {
			...
			return this.dStateEquation(x, y, id, element) + (this.dStateEquation(variables.xStar1[element], y, id, element)-this.dStateEquation(variables.xStar3[element], y, id, element));
			
		} else if (variables.xStar2[element]<x && x<0){
			
			return this.dStateEquation(variables.xStar2[element], y, id, element) + (this.dStateEquation(variables.xStar1[element], y, id, element)-this.dStateEquation(variables.xStar3[element], y, id, element));
	...
	public double pIntegral(double x, double y, int id, int element) {
		...
		if(x <=variables.xStar1[element]) {
			...
			return this.stateEquation(variables.xStar1[element], y, id, element) 
					+ this.dStateEquation(variables.xStar1[element], y, id, element)*(x-variables.xStar1[element])
					- this.dStateEquation(variables.xStar3[element], y, id, element)*(x-variables.xStar3[element])
			...
			return this.stateEquation(variables.xStar1[element], y, id, element)
					...
					- this.dStateEquation(variables.xStar3[element], y, id, element)*(variables.xStar2[element]-variables.xStar3[element])
	...
	public void computeXStar(double y, int id, int element) {
		...
		double x1 = super.rheology.parameters.par4[id]*Math.exp(-Math.pow(super.rheology.parameters.par2[id],2));
		variables.xStar1[element] = bisection.findZero(x1*1.1, x1*0.9, y, id, element);
		double x2 = super.rheology.parameters.par5[id]*Math.exp(-Math.pow(super.rheology.parameters.par3[id],2));
